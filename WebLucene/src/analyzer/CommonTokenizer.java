...
public class CommonTokenizer extends Tokenizer {
  ...
  /**
   * Creates a new instance of the {@link CommonTokenizer}. Attaches the
   * <code>input</code> to a newly created JFlex scanner.
   *
   * @deprecated Use {@link #CommonTokenizer(Version,
   * Reader)} instead
   */
  ...
  /**
   * Creates a new instance of the {@link org.apache.lucene.analysis.standard.CommonTokenizer}.  Attaches
   ...
   * See http://issues.apache.org/jira/browse/LUCENE-1068
   *
   * @deprecated Use {@link #CommonTokenizer(Version, Reader)} instead
   */
   ...
   *
   * @deprecated Use {@link #CommonTokenizer(Version, AttributeSource, Reader)} instead
   */
  ...
  /**
   * Prior to https://issues.apache.org/jira/browse/LUCENE-1068, CommonTokenizer mischaracterized as acronyms tokens like www.abc.com
   * when they should have been labeled as hosts instead.
   * @return true if CommonTokenizer now returns these tokens as Hosts, otherwise false
   *
