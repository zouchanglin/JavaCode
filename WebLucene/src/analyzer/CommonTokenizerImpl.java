 ...
 * <tt>/tango/mike/src/lucene.standarddigit/src/java/org/apache/lucene/analysis/standard/CommonTokenizerImpl.jflex</tt>
 */
class CommonTokenizerImpl{
...
final void getText(TermAttribute t) {
   ...
   */
  CommonTokenizerImpl(java.io.Reader in) {
    this.zzReader = in;
  }
   ...
   */
  CommonTokenizerImpl(java.io.InputStream in) {
  ...
  public int getNextToken() throws java.io.IOException {
	 // System.out.println("------------->"+ZZ_CMAP_PACKED);
    int zzInput;
    int zzAction;
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        ...
        case 13: break;
        case 1: 
          { return NUM;//standerTokebuzerImpl中为空，什么都没有写。Special characters
          }
        case 14: break;
        case 5: 
          { return NUM;
